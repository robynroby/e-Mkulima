...
async function getAccessToken() {
    const consumer_key = "c7RNENPs26oNjsMgGzk0p1nB6wfAKgkQPIOlKqvFIgVPd5n5"; // REPLACE IT WITH YOUR CONSUMER KEY
    const consumer_secret = "RlPOVaPAkgxkxwLtQZGadrLhqgATa0zxPB0A6R7ymstxU7iM3bBHZlBnITPCI1HT"; // REPLACE IT WITH YOUR CONSUMER SECRET
    const url =
        ...
        .then((accessToken) => {
            ...
            fetch(
                    url,
                    {
                        ...
                        CallBackURL: "http://test/api/callback",
                        AccountReference: "greenX test",
